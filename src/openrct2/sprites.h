...
enum
{
    ...
    SPR_G2_ALPINE_END = SPR_G2_ALPINE_LIFT_TRACK_GENTLE_DIAGONAL + 12,
  	...
  	SPR_G2_MONORAIL_BEGIN = SPR_G2_ALPINE_END,
	SPR_G2_MONORAIL_SHALLOW = SPR_G2_MONORAIL_BEGIN,
	SPR_G2_MONORAIL_END = SPR_G2_MONORAIL_SHALLOW + 16,

    SPR_G2_ICON_MEDIUM_CURVE_LEFT = SPR_G2_MONORAIL_END,
